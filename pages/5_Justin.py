...
st.title('justin Sentiment Analysis')
...
st.markdown('Let us first look at the evolution of the sentiment of the tweets about justin through the show:')
...
st.markdown('### Let us now look at the most frequent words used in the tweets about justin:')
...
for date in dates_2:
    ...
    positive_tweets = temp_df['text'][(temp_df['sentiment'] == option) & (temp_df['text'].str.lower().str.contains('justin'))]

...
st.title('johnny Sentiment Analysis')
...
st.markdown('Let us first look at the evolution of the sentiment of the tweets about johnny through the show:')
...
for date in dates_2:
    ...
    positive_tweets = temp_df['text'][(temp_df['sentiment'] == option) & (temp_df['text'].str.lower().str.contains('johnny'))]
